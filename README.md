...
- **Transaction & Installment management** — Full create, edit, delete, search, and filter capabilities with monthly grouping, merchant tracking, BRL monetary conversion display on transaction cards (with converted original values shown alongside), and multi-month installment support.
